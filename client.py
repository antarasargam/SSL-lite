...
class PLSClient(StackingProtocol):
    ...
    def connection_made(self, transport):
        ...
        idcert = getCertsForAddr("20174.1.666.46")  #This hardcoded IP address must the peerAddress
    ...
    def data_received(self, data):
        ...
        for packet in self.deserializer.nextPackets():
            ...
            if isinstance(packet, PlsKeyExchange):
                ...
                self.m.update(packet.__serialize__())
                myprivatekey = getPrivateKeyForAddr("20174.1.666.46") #This hardcoded IP address must the peerAddress
