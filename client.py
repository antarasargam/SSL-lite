...
class PLSClient(StackingProtocol):
    ...
    def connection_made(self, transport):
        ...
        idcert = getCertsForAddr("20174.1.666.2")  # This hardcoded IP address must the peerAddress
        ...
        if self.peerAddress == receivedIDCommonName:
            ...
            if serverissuer == intermediatesubject and FirstThreeOctets == intermediateCommonName:
                ...
                try:
                    ...
                    splitlist = re.split('(.*)\.(.*)\.(.*)', intermediateCommonName)[1:3]
    ...
    def data_received(self, data):
        ...
        for packet in self.deserializer.nextPackets():
            if isinstance(packet, PlsHello) and self.plsclientstate == 1:
                ...
                if self.validate(self.incoming_cert):
                    ...
                    encrypted1 = pub_key.encrypt(randomvalue, padding.OAEP(mgf=padding.MGF1(algorithm=hashes.SHA256()),
            ...
            if isinstance(packet, PlsKeyExchange) and self.plsclientstate == 2:
                ...
                self.m.update(packet.__serialize__())
                myprivatekey = getPrivateKeyForAddr("20174.1.666.2")  # This hardcoded IP address must the peerAddress
            ...
            if isinstance(packet, PlsHandshakeDone) and self.plsclientstate == 3:
            ...
            if isinstance(packet, PlsData) and self.plsclientstate > 3:
